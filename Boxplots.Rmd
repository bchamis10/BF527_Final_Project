...
# Download series matrix from GEO for the selected experiment
...
# ---- Aging genes boxplot with significance bars ----
p_aging <- ggboxplot(expr_long_aging, x = "Condition", y = "Expression", fill = "Condition",
          palette = "jco", add = "jitter",
          facet.by = "Gene", scales = "free_y", nrow = 1) +  # <--- all in one row
...
# ---- Upregulated genes with significance bars ----
...
ggsave("aging_genes.png", plot = p_aging, width = 9, height = 3.5, dpi = 300)
ggsave("upregulated_genes.png", plot = p_upreg, width = 9, height = 3.5, dpi = 300)
```